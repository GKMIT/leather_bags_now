						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_1_large.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_2_large.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_3_large.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_4_large.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
								</div>

								<div id="single-post5" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_5_large.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_1_thumb.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_2_thumb.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_3_thumb.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_4_thumb.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post5">
										<img src="assets/images/products/product-detail/leather messenger bag satchel retro look/leather_messenger_bag_satchel_retro_look_5_thumb.png" alt="Laptop" title="Leather Messenger Bag Satchel Retro Look" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/leather-messenger-bag-satchel-retro-look.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
