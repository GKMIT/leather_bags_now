...
<title>Leather Bags Now/Blog</title>
			...
			<div class="col-md-9">				
				<div class="post one-column">
					<div class="post-thumb">
						<img src="http://placehold.it/849x363" alt="" />
						<a href="blog-description-1.php" title="">VIEW MORE</a>
					</div>
					<h2><a href="#" title="">WE GIVE YOU BEST HOSTING SERVER IN THE WAY OF OFFER </a></h2>
					...
					<ul>
						...
						<li class="share-post"><a href="#" title=""><i class="fa fa-random"></i></a>
							<ul>
								<li><a href="http://www.facebook.com/leatherbagsnow" title=""><i class="fa fa-facebook"></i></a></li>
								<li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
								<li><a href="https://twitter.com/paliwalck" title=""><i class="fa fa-twitter"></i></a></li>
				...
				<div class="post one-column">
					...
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>
					<ul>
						<li><a href="#blog-1" title="">0 Comments</a></li>
						<li><a href="#" title="">Oct 08, 2013</a></li>
						<li class="share-post"><a href="#" title=""><i class="fa fa-random"></i></a>
							<ul>
