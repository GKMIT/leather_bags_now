							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								...
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/dark brown leather flap duffle bag satchel vintage look/dark_brown_leather_flap_duffle_bag_satchel_vintage_look_2_thumb.jpg" alt="Messenger" title="Dark Brown Leather Flap Duffle Dag Satchel Vintage Look" />
									</a>
								</li>
								<li>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/dark-brown-leather-flap-duffle-bag-satchel-vintage-look.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
							...
							<div class="choose-size-tab">
								...
								<ul class="nav nav-tabs" id="myTab2">
									...
									<li><a data-toggle="tab" href="#size-l">24'</a></li>
								</ul>
								...
								<div class="tab-content" id="product-sizes">
									...
									<a href='http://www.amazon.com/gp/product/B00NMDT09Y' target='blank'><img src='assets/images/amazon.png' class='amazon-link'/></a>
								</div>
							</div>
