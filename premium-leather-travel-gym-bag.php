...
<head>
	...
	<title>Leather Bags Now-Premium Leather Travel Gym Bag</title>
...
<section class="block" id="inner-head">
	...
	<div class="container">	
		<h1>PREMIUM LEATHER TRAVEL GYM BAG</h1>
	</div>
</section>
						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_1_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_2_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_3_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_4_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_1_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_2_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_3_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/premium leather travel gym bag/premium_leather_travel_gym_bag_4_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							<div class="single-post-head">
								<span>UB04</span>
								<h3 style='text-align: center; padding-right: 5px;'>Premium Leather Travel Gym Bag </h3>
							...
							<div class="choose-size-tab">
								...
								<div class="tab-content tab-features" id="product-sizes">
									<div class="tab-pane fade in active description">
										<p>Enhance your style quotient by this elegant and exclusive handbags. A must have bag that can go with everything in your wardrobe. This bag comes with two compartment and gives you enough room for all your essentials. You can carry it to a party, movie, college, office.</p>
										<ul>
			  ...
			  <div class="tab-content" id="myTabContent5">
				<div id="reviews" class="tab-pane fade active in">
					<div class="product-details">
						...
						<ul>
							<li><span>Type</span><p>Messenger/Shoulder</p></li>
							...
							<li><span>Straps</span><p>Three</p></li>
						</ul>
					</div>
				</div>
			  </div>
