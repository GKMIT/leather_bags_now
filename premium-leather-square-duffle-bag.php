...
<title>Leather Bags Now-Premium Leather Square Duffle Bag</title>
...
<section class="block" id="inner-head">
	...
	<div class="container">	
		<h1>PREMIUM LEATHER SQUARE DUFFLE BAG</h1>
	</div>
</section>
						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_1_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_2_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_3_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_4_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
								</div>
								<div id="single-post5" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_5_large.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_1_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_2_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_3_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_4_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post5">
										<img src="assets/images/products/product-detail/premium leather square duffle bag/premium_leather_square_duffle_bag_5_thumb.jpg" alt="Upcomming" title="Premium Leather Square Duffle Bag" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							<div class="single-post-head">
								<span>UB03</span>
								<h3 style='text-align: center; padding-right: 5px;'>Premium Leather Square Duffle Bag </h3>
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/premium-leather-square-duffle-bag.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
				...
				<div id="reviews" class="tab-pane fade active in">
					<div class="product-details">
						...
						<ul>
							...
							<li><span>Sizes</span><p>9' x 11', 10' x 12', 11' x 13', 12' x 13' Inches</p></li>
							<li><span>Material</span><p>Leather, Metal Accessories</p></li>
							<li><span>Number of Pockets</span><p>Four Pocket With Chain</p></li>
							<li><span>Number of Compartments</span><p>Three</p></li>
							<li><span>Straps</span><p>Two</p></li>
