...
<title>Leather Bags Now-Light Brown Leather Duffle Bag/Satchel</title>
...
<section class="block" id="inner-head">
	...
	<div class="container">	
		<h1>LIGHT BROWN LEATHER DUFFLE BAG/SATCHEL</h1>
	</div>
</section>
						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/light brown leather duffle bag satchel/light_brown_leather_duffle_bag_satchel_1_large.jpg" alt="Messenger" title="light brown leather duffle bag satchel" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/light brown leather duffle bag satchel/light_brown_leather_duffle_bag_satchel_2_large.jpg" alt="Messenger" title="light brown leather duffle bag satchel" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/light brown leather duffle bag satchel/light_brown_leather_duffle_bag_satchel_3_large.jpg" alt="Messenger" title="light brown leather duffle bag satchel" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/light brown leather duffle bag satchel/light_brown_leather_duffle_bag_satchel_1_thumb.jpg" alt="Messenger" title="light brown leather duffle bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/light brown leather duffle bag satchel/light_brown_leather_duffle_bag_satchel_2_thumb.jpg" alt="Messenger" title="light brown leather duffle bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/light brown leather duffle bag satchel/light_brown_leather_duffle_bag_satchel_3_thumb.jpg" alt="Messenger" title="light brown leather duffle bag satchel" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/light-brown-leather-duffle-bag-satchel.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
							<div class="choose-size-tab description">
								...
								<div class="tab-content tab-features" id="product-sizes">
									<div class="tab-pane fade in active description">
										<p>Enhance your style quotient by this elegant and exclusive handbag. This is a must have travel bag. It has one big inner compartment which can suffice all your travel needs. It also comes with two side pockets to store frequently used items. It can also be used as a gym bag. It has two strap options so that you can carry it on your shoulder or just lift it around with hands.	</p>
										<ul>
							...
							<div class="choose-size-tab">
								...
								<ul class="nav nav-tabs" id="myTab2">
									<li class="active"><a data-toggle="tab" href="#size-xl">20'</a></li>
									<li><a data-toggle="tab" href="#size-l">22'</a></li>
									<li><a data-toggle="tab" href="#size-m">24'</a></li>
								</ul>
			  ...
			  <div class="tab-content" id="myTabContent5">
				<div id="reviews" class="tab-pane fade active in">
					<div class="product-details">
						...
						<ul>
							<li><span>Type</span><p>Travel</p></li>
							<li><span>Color</span><p>Brown</p></li>
							<li><span>Sizes</span><p>20', 22', 24' Inches</p></li>
							<li><span>Material</span><p>Leather, Metal Accessories</p></li>
							<li><span>Number of Pockets</span><p>Two Side Pockets</p></li>
