...
<title>Leather Bags Now-Leather Bike Messenger Bag/Satchel</title>
...
<section class="block" id="inner-head">
	...
	<div class="container">	
		<h1>LEATHER BIKE MESSENGER BAG/SATCHEL</h1>
	</div>
</section>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								...
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/leather bike messenger bag satchel/leather_bike_messenger_bag_satchel_2_thumb.jpg" alt="Messenger" title="leather bike messenger bag satchel" />
									</a>
								</li>
								<li>
								...
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/leather bike messenger bag satchel/leather_bike_messenger_bag_satchel_4_thumb.jpg" alt="Messenger" title="leather bike messenger bag satchel" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							<div class="single-post-head">
								<span>GZ16</span>
								<h3 style='text-align: center; padding-right: 5px;'>Leather Bike Messenger Bag/Satchel </h3>
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/leather-bike-messenger-bag-satchel.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
							<div class="choose-size-tab description">
								...
								<div class="tab-content tab-features" id="product-sizes">
									<div class="tab-pane fade in active description">
										<p>Enhance your style quotient by this elegant and exclusive handbag. A must have bag that can go with everything in your wardrobe. This bag comes with two compartments and gives you enough room for all your essentials. It also has one front pocket. You can carry it to a party, movies, college or your office.</p>
										<ul>
							...
							<div class="choose-size-tab">
								...
								<div class="tab-content" id="product-sizes">
									...
									<a href='http://www.amazon.com/gp/product/B00NMEAP8I' target='blank'><img src='assets/images/amazon.png' class='amazon-link'/></a>
								</div>
							</div>
