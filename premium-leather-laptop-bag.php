...
<title>Leather Bags Now-Premium Leather Laptop Bag</title>
						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_1_large.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_2_large.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_3_large.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_4_large.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
								</div>
								<div id="single-post5" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_5_large.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_1_thumb.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_2_thumb.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_3_thumb.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_4_thumb.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post5">
										<img src="assets/images/products/product-detail/premium leather laptop bag/premium_leather_laptop_bag_5_thumb.jpg" alt="Upcomming" title="3 in 1 Leather Bag Shoulder Bag Backpack Briefcase" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/premium-leather-laptop-bag.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
				...
				<div id="reviews" class="tab-pane fade active in">
					<div class="product-details">
						...
						<ul>
							...
							<li><span>Material</span><p>Leather and Steel</p></li>
