						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_1_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_2_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_3_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_4_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_1_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_2_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_3_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/black leather messenger bag satchel/black_leather_messenger_bag_satchel_4_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
							</ul>
						...
						<div class="single-post-desc">
							...
							<div class="choose-size-tab description">
								...
								<div class="tab-content tab-features" id="product-sizes">
									<div class="tab-pane fade in active description">
										<p>Arrive your office in style with this exclusive leather office and laptop bag. This bag has two inner compartments. It also comes with a zipper pocket under the flap and one front pocket. It can accommodate all your business essentials, laptop, cell phone, important files etc. You can use it as a laptop bag, hand briefcase, messenger bag, shoulder bag by adjusting its strap.</p>
										<ul>
							...
							<div class="choose-size-tab">
								...
								<div class="tab-content" id="product-sizes">
									...
									<a href='http://www.amazon.com/gp/product/B00NGL0NNY' target='blank'><img src='assets/images/amazon.png' class='amazon-link'/></a>
								</div>
							</div>
		...
		<div class="shop-tabs">
			<div class="col-md-12">
			  <ul class="nav nav-tabs shop-tab" id="myTab3">
				<li class="active in"><a data-toggle="tab" href="#reviews">Features</a></li>
			  </ul>
