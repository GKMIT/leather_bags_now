...
<title>Leather Bags Now-3 IN 1 LEATHER BAG SHOULDER BAG BACKPACK BRIEFCASE</title>
...
<section class="block" id="inner-head">
	...
	<div class="container">	
		<h1>3 IN 1 LEATHER BAG SHOULDER BAG BACKPACK BRIEFCASE</h1>
	</div>
</section>
						...
						<div class="single-post-desc">
							...
							<div class="choose-size-tab">
								...
								<ul class="nav nav-tabs" id="myTab2">
									<li class="active"><a data-toggle="tab" href="#size-xl">11' x 16'</a></li>
