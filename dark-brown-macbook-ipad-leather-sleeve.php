						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_1_large.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_2_large.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_3_large.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_4_large.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
								</div>
								<div id="single-post5" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_5_large.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_1_thumb.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_2_thumb.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_3_thumb.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_4_thumb.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post5">
										<img src="assets/images/products/product-detail/dark brown macbook ipad leather sleeve/dark_brown_macbook_ipad_leather_sleeve_5_thumb.jpg" alt="Messenger" title="dark brown macbook ipad leather sleeve" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/dark-brown-macbook-ipad-leather-sleeve.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
							<div class="choose-size-tab description">
								...
								<div class="tab-content tab-features" id="product-sizes">
									<div class="tab-pane fade in active description">
										<p>Enhance your style quotient by this elegant and exclusive leather sleeve or pouch for your ipad, tablets. This is the most stylish way to carry your gadgets.</p>
										<ul>
