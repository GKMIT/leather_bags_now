						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_1_large.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_2_large.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_3_large.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_4_large.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
								</div>
								<div id="single-post5" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_5_large.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
								</div>
								<div id="single-post6" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_6_large.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_1_thumb.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_2_thumb.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_3_thumb.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_4_thumb.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post5">
										<img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_5_thumb.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post6">
										<img src="assets/images/products/product-detail/leather messenger bag satchel vintage look/leather_messenger_bag_satchel_vintage_look_6_thumb.jpg" alt="Messenger" title="leather messenger bag satchel vintage look" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/leather-messenger-bag-satchel-vintage-look.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
							...
							<div class="choose-size-tab">
								...
								<div class="tab-content" id="product-sizes">
									...
									<a href='http://www.amazon.com/gp/product/B00NGN0Y1I' target='blank'><img src='assets/images/amazon.png' class='amazon-link'/></a>
								</div>
							</div>
