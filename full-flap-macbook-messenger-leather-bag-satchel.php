							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								...
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/full flap macbook messenger leather bag satchel/full_flap_macbook_messenger_leather_bag_satchel_2_thumb.jpg" alt="Messenger" title="full flap macbook messenger leather bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/full flap macbook messenger leather bag satchel/full_flap_macbook_messenger_leather_bag_satchel_3_thumb.jpg" alt="Messenger" title="full flap macbook messenger leather bag satchel" />
									</a>
								</li>
								<li>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/full-flap-macbook-messenger-leather-bag-satchel.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
							...
							<div class="choose-size-tab">
								...
								<div class="tab-content" id="product-sizes">
									...
									<a href='http://www.amazon.com/gp/product/B00NMDEJTK' target='blank'><img src='assets/images/amazon.png' class='amazon-link'/></a>
								</div>
							</div>
