			...
			<div id="popular" class="tab-pane fade">
			  <div id="recent2" class="tab-pane fade in active">
				<div class="tab-recent" id="tab-popular">
					<ul>
						<li><span><img src="assets/images/side-bar/upcoming/3_in_1_leather_bag_shoulder_bag_backpack_briefcase.png" alt="3-in-1-leather-bag-shoulder-bag-backpack-briefcase" /></span>
							<h3><a href="3-in-1-leather-bag-shoulder-bag-backpack-briefcase.php" title="3-in-1-leather-bag-shoulder-bag-backpack-briefcase">3-in-1 leather bag shoulder bag backpack briefcase</a></h3>
						</li>

						<li><span><img src="assets/images/side-bar/upcoming/premium_leather_laptop_bag.png" alt="Premium Leather Laptop Bag" /></span>
							<h3><a href="premium-leather-laptop-bag.php" title="premium leather laptop bag">Premium Leather Laptop Bag</a></h3>
						</li>

						<li><span><img src="assets/images/side-bar/upcoming/premium_leather_square_duffle_bag.png" alt="Premium Leather Square Duffle Bag" /></span>
							<h3><a href="premium-leather-square-duffle-bag.php" title="premium leather square duffle bag">Premium Leather Square Duffle Bag</a></h3>
						</li>

						<li><span><img src="assets/images/side-bar/upcoming/premium_leather_travel_gym_bag.png" alt="Premium Leather Travel Gym Bag" /></span>
							<h3><a href="premium-leather-travel-gym-bag.php" title="premium leather travel gym bag">Premium Leather Travel Gym Bag</a></h3>
						</li>
					</ul>
					</div>
				</div>
