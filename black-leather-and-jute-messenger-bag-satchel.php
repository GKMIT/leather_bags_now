...
<section class="block" id="inner-head">
	...
	<div class="container">	
		<h1>BLACK LEATHER AND JUTE MESSENGER BAG/SATCHEL</h1>
	</div>
</section>
						...
						<div class="single-product-tab">						
							<div class="tab-content" id="single-post-content">
								<div id="single-post1" class="tab-pane fade in active">
								   <img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_1_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" /> 
								</div>
								<div id="single-post2" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_2_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
								</div>
								<div id="single-post3" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_3_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
								</div>
								<div id="single-post4" class="tab-pane fade">
								  <img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_4_large.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
								</div>
							</div>
							...
							<ul class="nav nav-tabs" id="single-post-tabs">
								<li class="active">
									<a data-toggle="tab" href="#single-post1">
										<img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_1_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post2">
										<img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_2_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post3">
										<img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_3_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
								<li>
									<a data-toggle="tab" href="#single-post4">
										<img src="assets/images/products/product-detail/black leather and jute messenger bag satchel/black_leather_and_jute_messenger_bag_satchel_4_thumb.jpg" alt="Messenger" title="black leather and jute messenger bag satchel" />
									</a>
								</li>
							</ul>
					...
					<div class="col-md-6">
						<div class="single-post-desc">
							...
							<p>
								...
								<div class="fb-like" data-href="http://www.leatherbagsnow.com/black-leather-and-jute-messenger-bag-satchel.php" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
